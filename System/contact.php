					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> kothamangalam, <br/> PO.BOX AX40, <br/>School Junction</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:aag@gmail.com">aag@gmail.com</a>
								</li>
								<li>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address :  PO.BOX AX40</p>
								<p>Email : <a href="aag2@gmail.com">aag2@gmail.com</a></p>
