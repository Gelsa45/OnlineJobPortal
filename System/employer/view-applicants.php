				...
				<div class="container">
					...
					<div class="employee-grid-wrapper">
						...
						<div class="GridLex-gap-15-wrappper">
							...
							$page1 = (int)$page1; // Ensure $page1 is an integer
							$stmt = $conn->prepare("SELECT * FROM tbl_job_applications WHERE job_id = ? ORDER BY id LIMIT ?,16");
							#$stmt->bindParam(':jobid', $job_id);
							#$stmt->bindParam(':jobid', $job_id, PDO::PARAM_INT); // bind job_id
            				#$stmt->bindParam(':page1', $page1, PDO::PARAM_INT);  // bind $page1
							$stmt->bind_param("ii", $job_id, $page1);  // 'ii' means tw
                            $stmt->execute();
                           # $result = $stmt->fetchAll();
							...
							?>
								...
								<?php
								$total_records = 0;
								$stmt = $conn->prepare("SELECT * FROM tbl_job_applications WHERE job_id = ? ORDER BY id");
								$stmt->bindParam('i', $job_id);
                                $stmt->execute();
                                $result = $stmt->get_result();
								    foreach($result as $row)
                                {
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<h5 class="footer-title">About</h5>
											<p>This is a job portal, online job management system .</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : Junction PO.BOX AX40</p>
