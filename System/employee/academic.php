						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<option disabled value="">Select</option>
						            <?php
									// Set default value if $ccountry is not set
									if (!isset($ccountry)) {
   									 $ccountry = '';  // You can change this to a default value, e.g., 'Afghanistan'
									}
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address :  School Junction PO.BOX AX40</p>
								<p>Email : <a href="mailto:th2@gmail.com">th2@gmail.com</a></p>
